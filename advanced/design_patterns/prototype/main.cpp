...
public:
  ...
  Prototype(std::string prototype_name)
      : m_prototype_name(prototype_name)
  {
  }
  virtual ~Prototype() {}
...
public:
  ConcretePrototype1(std::string prototype_name, float concrete_prototype_field)
      : Prototype(prototype_name), m_concrete_prototype_field1(concrete_prototype_field)
  {
  }
...
public:
  ConcretePrototype2(std::string prototype_name, float concrete_prototype_field)
      : Prototype(prototype_name), m_concrete_prototype_field2(concrete_prototype_field)
  {
  }
  Prototype *Clone() const override
  {
